...
> Fonte: `docs/product/operational-workflow.md`
...
Valida criação da OL, dados de agendamento, transportadora, portal, referência segura de acesso e requisitos para embarque.
