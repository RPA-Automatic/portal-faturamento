...
- Frontend atual: React + Vite + TypeScript.
- Evolucao opcional do frontend: Tailwind CSS, shadcn/ui e Lucide Icons conforme maturidade da UI.
- Backend/API: Supabase Edge Functions e jobs server-side seguros quando necessario.
