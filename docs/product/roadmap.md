...
A entrega está detalhada no [plano de quatro sprints de duas semanas](delivery-plan.md), vinculado ao épico #26 no Azure Boards. As fases abaixo representam a evolução do produto, não sprints adicionais ou compromisso de executar todas as evoluções no MVP.
